...
Versión: 2.0 - Integración Completa (AKF + UKF + EKF)
...
Simula:
1. Φ_γ - Factor de no-idealidad (Eq. 16.2) ✓ CORREGIDO
2. Longitud de Debye (Eq. 1.2) ✓
3. C_local(ω) - Capacidad de canal (Eq. 7) ✓ CORREGIDO
...
"""
    ...
    latex_code += f"D\_KL promedio (nats) & {metrics['AKF']['mean_DKL']:.3f} & {metrics['UKF']['mean_DKL']:.3f} & {metrics['EKF']['mean_DKL']:.3f} & AKF ({metrics['UKF']['mean_DKL']/metrics['AKF']['mean_DKL']:.1f}×) \\\\ \\hline\n"
